...
mod tests {
    ...
    use crate::app::selection::edges::logical::expressions::{Expression, ExpressionDefinition, ExpressionAddress, NextExpressionAddressWithOperator};
    ...
    fn build_evaluator() -> SelectionTreeEvaluator {
            ...
            SelectionNode::Dictionary(
                DictionarySelectionNode::new(
                    ...
                    DictionaryNodeMapping::new(6,
                                               build_map(
                                                   vec!{
                                                       (ValueHolder::String("FirstVal".to_string()),
                                                        7),
                                                       (ValueHolder::String("SecondVal".to_string()),
                                                        8),
                                                       (ValueHolder::String("ThirdVal".to_string()),
                                                        9)
                                                   })
                    ))
            )
        ...
        let edges: Vec<SelectionEdge> = vec![
            ...
            SelectionEdge::LogicalExpressionSelectionEdge(LogicalExpressionSelectionEdge::new(
                SelectionEdgeDefinition::new(
                    0,
                    1,
                    SelectionEdgeType::LogicalExpressionSelectionEdge),
    ...
    fn build_map(entries: Vec<(ValueHolder, i32)>) -> HashMap<ValueHolder, i32> {
